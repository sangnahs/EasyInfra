<html>
  <head>
    ...
    function drawChart() {
      ...
      // draw red chart
      var redJsonData = $.ajax({
          url: "test.php",
          dataType: "json",
          data:{name1:filename,name2:redFilename,JuncName:junctionName},
          async: false
          }).responseText;

      // Create our data table out of JSON data loaded from server.
      var redData = new google.visualization.DataTable(redJsonData);

      // Instantiate and draw our chart, passing in some options.
      //var redChart = new google.visualization.ScatterChart(document.getElementById('red_chart'));
      var redChart = new google.visualization.LineChart(document.getElementById('red_chart'));
      redChart.draw(redData, options);
